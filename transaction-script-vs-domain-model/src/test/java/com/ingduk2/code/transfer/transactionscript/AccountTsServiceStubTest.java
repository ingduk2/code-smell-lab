...
class AccountTsServiceStubTest {
    ...
    @BeforeEach
    void setUp() {
        accountTsRepository = new AccountTsRepositoryStub();
    ...
    class WithDraw {
        ...
        void fail1() {
            AccountTs account = accountTsRepository.save(createAccountTs(BigDecimal.valueOf(300)));
        ...
        @Test
        void success1() {
            AccountTs account = accountTsRepository.save(createAccountTs(BigDecimal.valueOf(1000)));
    ...
    class TransferTo {
        ...
        void fail2() {
            AccountTs account1 = accountTsRepository.save(createAccountTs(BigDecimal.valueOf(300)));
            AccountTs account2 = accountTsRepository.save(createAccountTs(BigDecimal.valueOf(1000)));
        ...
        @Test
        void success1() {
            AccountTs account1 = accountTsRepository.save(createAccountTs(BigDecimal.valueOf(600)));
            AccountTs account2 = accountTsRepository.save(createAccountTs(BigDecimal.valueOf(1000)));
